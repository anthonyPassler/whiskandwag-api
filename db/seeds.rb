...
Recipe.create(name: "Beef stew", kcal_per_100g: 125, ingredients: %w[beef potato carrots], fat_percentage: 15,
              price: 25)
Dog.create(name: "Lucky", breed: "Labrador", weight: 50, age: 5, gender: "male", fussiness_level: "medium",
           health_issues: ["obese"], activity_level: "low", allergies: ["Beef"], kcal_per_day: 1000, food_portion_in_grams: 200, user_id: user.id)
